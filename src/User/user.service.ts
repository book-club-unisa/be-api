import { HttpException, HttpStatus, Inject, Injectable, NotFoundException, UseInterceptors } from '@nestjs/common';
...
export class UserService {
  ...
  async findUser(email : string, password :string) : Promise<User>{
    ...
    try{
      ...
      else throw new HttpException('Invalid Email or Password',HttpStatus.BAD_REQUEST);
    }catch(err){
